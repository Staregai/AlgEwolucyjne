...
def plot_convergence_curves(curves_dir="convergence_curves", func_name="rastrigin", strategies=None, save_dir="plots"):
    ...
    # --- 1. Rysuj osobne wykresy dla każdego wymiaru ---
    for dim in DIMS:
        ...
        for strategy in strategies:
            ...
            if not files:
                print(f"Brak plików dla strategii {strategy}, funkcji {func_name}, dim={dim}")
            for file in files:
                df = pd.read_csv(file)
